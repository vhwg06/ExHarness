export const ExHarnessErrorCode = Object.freeze({
  ...
  LIVE_OBJECT_REF_INVALID: "LIVE_OBJECT_REF_INVALID",
  LIVE_OBJECT_REVOKED: "LIVE_OBJECT_REVOKED",
  LIVE_OBJECT_EXPIRED: "LIVE_OBJECT_EXPIRED",
  LIVE_OBJECT_ACCESS_DENIED: "LIVE_OBJECT_ACCESS_DENIED",
  LIVE_OBJECT_MEMBER_NOT_ALLOWED: "LIVE_OBJECT_MEMBER_NOT_ALLOWED",
  LIVE_OBJECT_SURFACE_CONFLICT: "LIVE_OBJECT_SURFACE_CONFLICT",
  LIVE_OBJECT_LIMIT_EXCEEDED: "LIVE_OBJECT_LIMIT_EXCEEDED",
  ...
  RUNTIME_SNAPSHOT_LIVE_OBJECT_REBIND_REQUIRED: "RUNTIME_SNAPSHOT_LIVE_OBJECT_REBIND_REQUIRED",
...
export class LiveObjectAccessError extends ExHarnessError {
  constructor(code, message, details = null) {
    super(code, message, { details });
    this.name = "LiveObjectAccessError";
  }
}
