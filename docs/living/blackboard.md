...
current-context:
  generation: 12
  ref: docs/living/work-context/BB-047/g0012-authority-provenance-implementation.json
depends-on: []
target-consumer:
...
submission:
  - g0011 REJECT review evidence 5256017957; g0012 fresh authority-provenance implementation
...
blockers: []
remaining-work:
  - fresh review of D019 four-P1 repair candidate
  - fresh durability/publisher-boundary and crash/race/reconciliation review
follow-up-refs:
