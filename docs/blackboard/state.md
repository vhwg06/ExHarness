...
current-context:
  generation: 5
  ref: docs/blackboard/context/BB-048/g0005-implementation-readiness-review.json
...
next:
  - execute fresh review from exact g0005 context
  - on ACCEPT, materialize bounded g0006 IMPLEMENT context for Worker
